...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.ac, "AC DC", "AC DC"));
        items.add(new ItemsList(R.mipmap.met, "Mago de Oz", "Mago de Oz"));
        items.add(new ItemsList(R.mipmap.slipknot, "Slipknot", "Slipknot"));
        items.add(new ItemsList(R.mipmap.metallica, "Metallica", "Metallica"));
